...
<!--=== Content Part ===-->
          ...
          <div class="container content-sm">
				<div class="row">
				       <div class="headline headline-center"><h2>List of Events</h2></div>	
            <!-- Begin Easy Block --> 
           <?php
			  include_once 'config/db.php';
			 $stmt = $conn->prepare('SELECT ID, title,short_description,speaker,date FROM events ORDER BY ID DESC ');
			 $stmt->execute();
            ...
            <div class="col-md-12">
                <div class="easy-block-v2">
							...
							<h3><a href="detailevents.php?edit_id=<?php echo $row['ID']; ?>"><?php echo $title ?></a></h3>
							<div class="post-author">
								<strong>By <?php echo $speaker ?></strong>
